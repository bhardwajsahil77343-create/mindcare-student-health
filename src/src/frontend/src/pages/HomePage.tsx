...
export function HomePage({ navigate }: Props) {
  ...
  return (
    <div className="overflow-hidden">
      ...
      {/* Footer */}
      <footer className="bg-[#F6F4F1] py-12">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between gap-8">
            <div>
              <div className="flex items-center gap-2 mb-3">
                <div className="w-7 h-7 rounded-full bg-[#C04444] flex items-center justify-center">
                  <span className="text-white text-xs font-bold">♥</span>
                </div>
                <span className="font-bold text-[#111]">MindCare</span>
              </div>
              <p className="text-sm text-[#7A7A7A] max-w-xs">
                Connecting college students with qualified mental health
                professionals.
              </p>
            </div>
            <div className="flex gap-12">
              <div>
                <h4 className="font-semibold text-[#111] mb-3 text-sm">
                  Quick Links
                </h4>
                <ul className="space-y-2 text-sm text-[#7A7A7A]">
                  <li>
                    <button
                      ...
                      className="hover:text-[#C04444] transition-colors"
                    >
                      Home
                    </button>
                  </li>
          ...
          <div className="mt-8 pt-8 border-t border-[#E9E6E2] text-center text-xs text-[#7A7A7A]">
            © 2026 MindCare Student Health. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
